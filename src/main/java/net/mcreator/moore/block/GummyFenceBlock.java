...
public class GummyFenceBlock extends MooreModElements.ModElement {
	@ObjectHolder("moore:gummy_fence")
	public static final Block block = null;
	public GummyFenceBlock(MooreModElements instance) {
		super(instance, 25);
	}
