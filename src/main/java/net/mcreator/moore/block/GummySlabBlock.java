...
public class GummySlabBlock extends MooreModElements.ModElement {
	@ObjectHolder("moore:gummy_slab")
	public static final Block block = null;
	public GummySlabBlock(MooreModElements instance) {
		super(instance, 24);
	}
