...
public class PlatiniumingotItem extends MooreModElements.ModElement {
	@ObjectHolder("moore:platiniumingot")
	public static final Item block = null;
	public PlatiniumingotItem(MooreModElements instance) {
		super(instance, 6);
	}
