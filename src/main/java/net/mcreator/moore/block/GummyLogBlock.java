...
public class GummyLogBlock extends MooreModElements.ModElement {
	@ObjectHolder("moore:gummy_log")
	public static final Block block = null;
	public GummyLogBlock(MooreModElements instance) {
		super(instance, 20);
	}
