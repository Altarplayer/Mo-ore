...
public class GummyPlanksBlock extends MooreModElements.ModElement {
	@ObjectHolder("moore:gummy_planks")
	public static final Block block = null;
	public GummyPlanksBlock(MooreModElements instance) {
		super(instance, 21);
	}
