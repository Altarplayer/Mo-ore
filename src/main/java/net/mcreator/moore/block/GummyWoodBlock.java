...
public class GummyWoodBlock extends MooreModElements.ModElement {
	@ObjectHolder("moore:gummy_wood")
	public static final Block block = null;
	public GummyWoodBlock(MooreModElements instance) {
		super(instance, 19);
	}
