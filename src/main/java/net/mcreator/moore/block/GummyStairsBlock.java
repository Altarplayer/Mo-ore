...
public class GummyStairsBlock extends MooreModElements.ModElement {
	@ObjectHolder("moore:gummy_stairs")
	public static final Block block = null;
	public GummyStairsBlock(MooreModElements instance) {
		super(instance, 23);
	}
