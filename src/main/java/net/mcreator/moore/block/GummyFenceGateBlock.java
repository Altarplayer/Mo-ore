...
public class GummyFenceGateBlock extends MooreModElements.ModElement {
	@ObjectHolder("moore:gummy_fence_gate")
	public static final Block block = null;
	public GummyFenceGateBlock(MooreModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("gummy_fence_gate");
		}
